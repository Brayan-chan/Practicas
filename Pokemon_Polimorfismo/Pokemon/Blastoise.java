...
public class Blastoise extends Pokemon implements ClaseInterfaz {
    ...
    public Blastoise(String nombre, int nivel, int PS, int ataque,
        ...
        setMovimientos(0, listaMovimientos.buscarMovimientoPorNombre("Golpe de cabeza"));
        setMovimientos(1, listaMovimientos.buscarMovimientoPorNombre("Pistola Agua Water Gun"));
